...
- [ ] 展示物
  - [ ] CheenRimen（ABC2017展示物）
    - OMMF2016のサンタの方が良ければそっちもアプリ入ってます。<br>(その場合Web Audioで音も出るのでスピーカーが必要)
      - USBスピーカーでもおｋですか？
          - 3.5mm stereo jack経由で繋がるやつなら使えます
  - [ ] pikox2 @gurezo
  - [ ] 連打ゲーム（ABC2017展示物） @kazy
  - [ ] 教育イベントコンテンツ：ゲームコントローラー？@関口
  - [ ] chirimen on ラズパイ? @naokisekiguchi
- [x] チラシ、シール
  - シール 300枚弱
  - チラシ 大小100枚以上？
...
### 展示物　TBD
- 概要：Report: 2nd IEEE Hack Challenge in Tokyo レポート等
- 電源：レポート自動再生PC?
- 構成：レポート自動再生PC?、レポート（紙媒体）
- 必要スペース：300mm x 300mm 以内
